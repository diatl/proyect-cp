...
with st.container():
    ...
    if button_search:
        ...
        try:
            ...
            st.write("Error when searching for the video, this error is due to two possible reasons, either you did not enter the URL correctly, or the video you want to download is not available.", str(e))
